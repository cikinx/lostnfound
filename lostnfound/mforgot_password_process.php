...
// Database connection
include 'mconnect.php'; // Assuming this connects to the correct database
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $query = "SELECT * FROM musers WHERE email = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $updateQuery = "UPDATE musers SET reset_token = ?, token_expiry = ? WHERE email = ?";
            ...
            try {
                ...
                $resetLink = "http://$host/lostnfound/mreset_password.php?token=$token";
