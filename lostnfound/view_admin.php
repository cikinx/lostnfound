...
<body>
    ...
    <div class="search-container">
        <form method="GET" action="">
            <input type="text" name="search" placeholder="Search Admins" value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
    ...
    <table>
        ...
        <a href="mdashboard.php" class="back-button">&#8592; Back to Dashboard</a>
            ...
            if (isset($_GET['search']) && !empty($_GET['search'])) {
                ...
                $sql = "SELECT * FROM musers WHERE firstName LIKE '%$search%' OR lastName LIKE '%$search%' ORDER BY Id DESC";
            } else {
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><a href="delete_admin.php?Id=<?= $row['Id'] ?>" class="btn-delete">Delete</a>
                        &nbsp;
                        <a href="update_admin.php?Id=<?= $row['Id'] ?>" class="btn-update">Update</a></td>
